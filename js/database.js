...
var CHARACTER_LIST = [
    ...
    new Character("lanyan", 4, { chs: "翦玉编春", eng: "Spring Woven From Jade" }, Element.anemo, { chs: "蓝砚", eng: "Lan Yan" }),
    //inazuma
    ...
    new Character("mizuki", 5, { chs: "绮梦缱绻", eng: "Embrace of Enchanting Dreams" }, Element.anemo, { chs: "梦见月瑞希", eng: "Yumemizuki Mizuki" }),
    //sumeru
    ...
    new Character("mavuika", 5, { chs: "焚夜以炎", eng: "Night-Igniting Flame" }, Element.pyro, { chs: "玛薇卡", eng: "Mavuika" }),
    new Character("citlali", 5, { chs: "白星黑曜", eng: "Obsidian Opalstar" }, Element.cryo, { chs: "茜特菈莉", eng: "Citlali" }),
    new Character("varesa", 5, { chs: "悠暇豪劲", eng: "Strength in Serenity" }, Element.electro, { chs: "瓦雷莎", eng: "Varesa" }),
    new Character("iansan", 4, { chs: "熔石百炼", eng: "Tempered in Molten Stone" }, Element.electro, { chs: "伊安珊", eng: "Iansan" }),
    //
...
var WEAPON_LIST = [
    ...
    new Weapon("A_Thousand_Blazing_Suns", 5, WeaponType.claymore, "焚曜千阳"),
    ...
    new Weapon("Starcaller's_Watch", 5, WeaponType.catalyst, "祭星者之望"),
    new Weapon("Summit_Shaper", 5, WeaponType.sword, "斫峰之刃"),
    new Weapon("Sunny_Morning_Sleep-In", 5, WeaponType.catalyst, "寝正月初晴"),
    ...
    new Weapon("Vivid_Notions", 5, WeaponType.catalyst, "溢彩心念"),
...
const itemPools = {
    ...
    wish_5_5_3: [
        ["xilonen"],
        ["jean", "qiqi", "tighnari", "keqing", "mona", "dehya", "diluc", "mizuki"],
        ["faruzan", "beidou", "yanfei"],
        ["barbara", "bennett", "candace", "charlotte", "chevreuse", "chongyun", "collei", "diona", "dori", "fischl", "freminet", "gaming", "gorou", "kachina", "kaveh", "kirara", "rosaria", "sara", "shinobu", "lanyan", "layla", "lynette", "mika", "ningguang", "noelle", "ororon", "razor", "sayu", "sethos", "heizo", "sucrose", "thoma", "xiangling", "xingqiu", "xinyan", "yaoyao", "yunjin"],
    ...
    wish_5_5_1: [
        ["varesa"],
        ["jean", "qiqi", "tighnari", "keqing", "mona", "dehya", "diluc", "mizuki"],
        ["iansan", "chevreuse", "gaming"],
        ["barbara", "beidou", "bennett", "candace", "charlotte", "chongyun", "collei", "diona", "dori", "faruzan", "fischl", "freminet", "gorou", "kachina", "kaveh", "kirara", "rosaria", "sara", "shinobu", "lanyan", "layla", "lynette", "mika", "ningguang", "noelle", "ororon", "razor", "sayu", "sethos", "heizo", "sucrose", "thoma", "xiangling", "xingqiu", "xinyan", "yanfei", "yaoyao", "yunjin"],
        ["Dragon's_Bane", "Eye_of_Perception", "Favonius_Codex", "Favonius_Greatsword", "Favonius_Lance", "Favonius_Sword", "Favonius_Warbow", "Lion's_Roar", "Rainslasher", "Rust", "Sacrificial_Bow", "Sacrificial_Fragments", "Sacrificial_Greatsword", "Sacrificial_Sword", "The_Bell", "The_Flute", "The_Stringless", "The_Widsith"]
    ],
    wish_5_5_2: [
        ["xianyun"],
    ...
    wish_5_4_3: [
        ...
        ["charlotte", "chongyun", "mika"],
        ["barbara", "beidou", "bennett", "candace", "chevreuse", "collei", "diona", "dori", "faruzan", "fischl", "freminet", "gaming", "gorou", "kachina", "kaveh", "kirara", "rosaria", "sara", "shinobu", "lanyan", "layla", "lynette", "ningguang", "noelle", "ororon", "razor", "sayu", "sethos", "heizo", "sucrose", "thoma", "xiangling", "xingqiu", "xinyan", "yanfei", "yaoyao", "yunjin"],
        ["Dragon's_Bane", "Eye_of_Perception", "Favonius_Codex", "Favonius_Greatsword", "Favonius_Lance", "Favonius_Sword", "Favonius_Warbow", "Lion's_Roar", "Rainslasher", "Rust", "Sacrificial_Bow", "Sacrificial_Fragments", "Sacrificial_Greatsword", "Sacrificial_Sword", "The_Bell", "The_Flute", "The_Stringless", "The_Widsith"]
    ],
    wish_5_4_4: [
        ["wriothesley"],
    ...
    wish_5_4_1: [
        ["mizuki"],
        ["jean", "qiqi", "tighnari", "keqing", "mona", "dehya", "diluc"],
        ["gorou", "sayu", "xiangling"],
        ["barbara", "beidou", "bennett", "candace", "charlotte", "chevreuse", "chongyun", "collei", "diona", "dori", "faruzan", "fischl", "freminet", "gaming", "kachina", "kaveh", "kirara", "rosaria", "sara", "shinobu", "lanyan", "layla", "lynette", "mika", "ningguang", "noelle", "ororon", "razor", "sethos", "heizo", "sucrose", "thoma", "xingqiu", "xinyan", "yanfei", "yaoyao", "yunjin"],
        ["Dragon's_Bane", "Eye_of_Perception", "Favonius_Codex", "Favonius_Greatsword", "Favonius_Lance", "Favonius_Sword", "Favonius_Warbow", "Lion's_Roar", "Rainslasher", "Rust", "Sacrificial_Bow", "Sacrificial_Fragments", "Sacrificial_Greatsword", "Sacrificial_Sword", "The_Bell", "The_Flute", "The_Stringless", "The_Widsith"]
    ],
    wish_5_4_2: [
        ["sigewinne"],
    ...
    wish_5_3_3: [
        ["arlecchino"],
        ["jean", "qiqi", "tighnari", "keqing", "mona", "dehya", "diluc"],
        ["lanyan", "chevreuse", "rosaria"],
        ["barbara", "beidou", "bennett", "candace", "charlotte", "chongyun", "collei", "diona", "dori", "faruzan", "fischl", "freminet", "gaming", "gorou", "kachina", "kaveh", "kirara", "sara", "shinobu", "layla", "lynette", "mika", "ningguang", "noelle", "ororon", "razor", "sayu", "sethos", "heizo", "sucrose", "thoma", "xiangling", "xingqiu", "xinyan", "yanfei", "yaoyao", "yunjin"],
        ["Dragon's_Bane", "Eye_of_Perception", "Favonius_Codex", "Favonius_Greatsword", "Favonius_Lance", "Favonius_Sword", "Favonius_Warbow", "Lion's_Roar", "Rainslasher", "Rust", "Sacrificial_Bow", "Sacrificial_Fragments", "Sacrificial_Greatsword", "Sacrificial_Sword", "The_Bell", "The_Flute", "The_Stringless", "The_Widsith"]
    ],
    wish_5_3_4: [
        ["clorinde"],
    ...
    wish_5_3_1: [
        ["mavuika"],
        ["jean", "qiqi", "tighnari", "keqing", "mona", "dehya", "diluc"],
        ["kachina", "bennett", "diona"],
        ["barbara", "beidou", "candace", "charlotte", "chevreuse", "chongyun", "collei", "dori", "faruzan", "fischl", "freminet", "gaming", "gorou", "kaveh", "kirara", "sara", "heizo", "shinobu", "layla", "lynette", "mika", "ningguang", "noelle", "ororon", "razor", "rosaria", "sayu", "sethos", "sucrose", "thoma", "xiangling", "xingqiu", "xinyan", "yanfei", "yaoyao", "yunjin"],
        ["Dragon's_Bane", "Eye_of_Perception", "Favonius_Codex", "Favonius_Greatsword", "Favonius_Lance", "Favonius_Sword", "Favonius_Warbow", "Lion's_Roar", "Rainslasher", "Rust", "Sacrificial_Bow", "Sacrificial_Fragments", "Sacrificial_Greatsword", "Sacrificial_Sword", "The_Bell", "The_Flute", "The_Stringless", "The_Widsith"]
    ],
    wish_5_3_2: [
        ["citlali"],
...
const weaponPools = {
    wish_5_5_2: [
        ["Peak_Patrol_Song", "Elegy_for_the_End"],
        ...
        ["Sacrificial_Sword", "The_Bell", "Favonius_Lance", "Favonius_Codex", "Favonius_Warbow"],
        ["Dragon's_Bane", "Eye_of_Perception", "Favonius_Greatsword", "Favonius_Sword", "Lion's_Roar", "Rainslasher", "Rust", "Sacrificial_Bow", "Sacrificial_Fragments", "Sacrificial_Greatsword", "The_Flute", "The_Stringless", "The_Widsith"],
        ["barbara", "beidou", "bennett", "candace", "charlotte", "chevreuse", "chongyun", "collei", "diona", "dori", "faruzan", "fischl", "freminet", "gaming", "gorou", "kachina", "kaveh", "kirara", "sara", "shinobu", "lanyan", "layla", "lynette", "mika", "ningguang", "noelle", "ororon", "razor", "rosaria", "sayu", "sethos", "heizo", "sucrose", "thoma", "xiangling", "xingqiu", "xinyan", "yanfei", "yaoyao", "yunjin"],
    ],
    wish_5_5_1: [
        ["Vivid_Notions", "Crane's_Echoing_Call"],
        ["Amos'_Bow", "Aquila_Favonia", "Lost_Prayer_to_the_Sacred_Winds", "Primordial_Jade_Winged-Spear", "Skyward_Atlas", "Skyward_Blade", "Skyward_Harp", "Skyward_Pride", "Skyward_Spine", "Wolf's_Gravestone"],
        ["Sturdy_Bone", "Fruitful_Hook", "Mountain-Bracing_Bolt", "Waveriding_Whirl", "Flower-Wreathed_Feathers"],
        ["Dragon's_Bane", "Eye_of_Perception", "Favonius_Codex", "Favonius_Greatsword", "Favonius_Lance", "Favonius_Sword", "Favonius_Warbow", "Lion's_Roar", "Rainslasher", "Rust", "Sacrificial_Bow", "Sacrificial_Fragments", "Sacrificial_Greatsword", "Sacrificial_Sword", "The_Bell", "The_Flute", "The_Stringless", "The_Widsith"],
        ["barbara", "beidou", "bennett", "candace", "charlotte", "chevreuse", "chongyun", "collei", "diona", "dori", "faruzan", "fischl", "freminet", "gaming", "gorou", "kachina", "kaveh", "kirara", "sara", "shinobu", "lanyan", "layla", "lynette", "mika", "ningguang", "noelle", "ororon", "razor", "rosaria", "sayu", "sethos", "heizo", "sucrose", "thoma", "xiangling", "xingqiu", "xinyan", "yanfei", "yaoyao", "yunjin"],
    ],
    wish_5_4_2: [
        ["Splendor_of_Tranquil_Waters", "Cashflow_Supervision"],
        ["Amos'_Bow", "Aquila_Favonia", "Lost_Prayer_to_the_Sacred_Winds", "Primordial_Jade_Winged-Spear", "Skyward_Atlas", "Skyward_Blade", "Skyward_Harp", "Skyward_Pride", "Skyward_Spine", "Wolf's_Gravestone"],
        ["Favonius_Sword", "Sacrificial_Greatsword", "Dragon's_Bane", "Sacrificial_Fragments", "Rust"],
        ["Eye_of_Perception", "Favonius_Codex", "Favonius_Greatsword", "Favonius_Lance", "Favonius_Warbow", "Lion's_Roar", "Rainslasher", "Sacrificial_Bow", "Sacrificial_Sword", "The_Bell", "The_Flute", "The_Stringless", "The_Widsith"],
        ["barbara", "beidou", "bennett", "candace", "charlotte", "chevreuse", "chongyun", "collei", "diona", "dori", "faruzan", "fischl", "freminet", "gaming", "gorou", "kachina", "kaveh", "kirara", "sara", "shinobu", "lanyan", "layla", "lynette", "mika", "ningguang", "noelle", "ororon", "razor", "rosaria", "sayu", "sethos", "heizo", "sucrose", "thoma", "xiangling", "xingqiu", "xinyan", "yanfei", "yaoyao", "yunjin"],
    ],
    wish_5_4_1: [
        ["Sunny_Morning_Sleep-In", "Silvershower_Heartstrings"],
        ["Amos'_Bow", "Aquila_Favonia", "Lost_Prayer_to_the_Sacred_Winds", "Primordial_Jade_Winged-Spear", "Skyward_Atlas", "Skyward_Blade", "Skyward_Harp", "Skyward_Pride", "Skyward_Spine", "Wolf's_Gravestone"],
        ["Akuoumaru", "Wavebreaker's_Fin", "Mouun's_Moon", "The_Flute", "Eye_of_Perception"],
        ["Dragon's_Bane", "Favonius_Codex", "Favonius_Greatsword", "Favonius_Lance", "Favonius_Sword", "Favonius_Warbow", "Lion's_Roar", "Rainslasher", "Rust", "Sacrificial_Bow", "Sacrificial_Fragments", "Sacrificial_Greatsword", "Sacrificial_Sword", "The_Bell", "The_Stringless", "The_Widsith"],
        ["barbara", "beidou", "bennett", "candace", "charlotte", "chevreuse", "chongyun", "collei", "diona", "dori", "faruzan", "fischl", "freminet", "gaming", "gorou", "kachina", "kaveh", "kirara", "sara", "shinobu", "lanyan", "layla", "lynette", "mika", "ningguang", "noelle", "ororon", "razor", "rosaria", "sayu", "sethos", "heizo", "sucrose", "thoma", "xiangling", "xingqiu", "xinyan", "yanfei", "yaoyao", "yunjin"],
    ],
    wish_5_3_2: [
        ["Crimson_Moon's_Semblance", "Absolution"],
        ["Amos'_Bow", "Aquila_Favonia", "Lost_Prayer_to_the_Sacred_Winds", "Primordial_Jade_Winged-Spear", "Skyward_Atlas", "Skyward_Blade", "Skyward_Harp", "Skyward_Pride", "Skyward_Spine", "Wolf's_Gravestone"],
        ["Lion's_Roar", "Rainslasher", "The_Widsith", "Sacrificial_Bow", "Lithic_Spear"],
        ["Dragon's_Bane", "Eye_of_Perception", "Favonius_Codex", "Favonius_Greatsword", "Favonius_Lance", "Favonius_Sword", "Favonius_Warbow", "Rust", "Sacrificial_Fragments", "Sacrificial_Greatsword", "Sacrificial_Sword", "The_Bell", "The_Flute", "The_Stringless"],
        ["barbara", "beidou", "bennett", "candace", "charlotte", "chevreuse", "chongyun", "collei", "diona", "dori", "faruzan", "fischl", "freminet", "gaming", "gorou", "kachina", "kaveh", "kirara", "sara", "shinobu", "layla", "lynette", "mika", "ningguang", "noelle", "ororon", "razor", "rosaria", "sayu", "sethos", "heizo", "sucrose", "thoma", "xiangling", "xingqiu", "xinyan", "yanfei", "yaoyao", "yunjin"],
    ],
    wish_5_3_1: [
        ["A_Thousand_Blazing_Suns", "Starcaller's_Watch"],
        ["Amos'_Bow", "Aquila_Favonia", "Lost_Prayer_to_the_Sacred_Winds", "Primordial_Jade_Winged-Spear", "Skyward_Atlas", "Skyward_Blade", "Skyward_Harp", "Skyward_Pride", "Skyward_Spine", "Wolf's_Gravestone"],
        ["Lithic_Blade", "Sacrificial_Sword", "Favonius_Lance", "Favonius_Codex", "The_Stringless"],
        ["Dragon's_Bane", "Eye_of_Perception", "Favonius_Greatsword", "Favonius_Sword", "Favonius_Warbow", "Lion's_Roar", "Rainslasher", "Rust", "Sacrificial_Bow", "Sacrificial_Fragments", "Sacrificial_Greatsword", "The_Bell", "The_Flute", "The_Widsith"],
        ["barbara", "beidou", "bennett", "candace", "charlotte", "chevreuse", "chongyun", "collei", "diona", "dori", "faruzan", "fischl", "freminet", "gaming", "gorou", "kachina", "kaveh", "kirara", "sara", "shinobu", "layla", "lynette", "mika", "ningguang", "noelle", "ororon", "razor", "rosaria", "sayu", "sethos", "heizo", "sucrose", "thoma", "xiangling", "xingqiu", "xinyan", "yanfei", "yaoyao", "yunjin"],
    ],
    wish_5_2_2: [
...
var chronicledPools = {
    wish_5_3_1_C: [
        ["baizhu", "shenhe", "keqing", "ganyu", "qiqi", "tartaglia", "xiao"],
        ["beidou", "chongyun", "gaming", "ningguang", "xiangling", "xingqiu", "xinyan", "yanfei", "yaoyao", "yunjin"],
        ["Dragon's_Bane", "Eye_of_Perception", "Favonius_Codex", "Favonius_Greatsword", "Favonius_Lance", "Favonius_Sword", "Favonius_Warbow", "Lion's_Roar", "Lithic_Blade", "Lithic_Spear", "Rainslasher", "Rust", "Sacrificial_Bow", "Sacrificial_Fragments", "Sacrificial_Greatsword", "Sacrificial_Sword", "The_Bell", "The_Flute", "The_Stringless", "The_Widsith"]
    ],
    wish_5_3_1_W: [
        ["Primordial_Jade_Cutter", "Summit_Shaper", "The_Unforged", "Calamity_Queller", "Primordial_Jade_Winged-Spear", "Jadefall's_Splendor", "Memory_of_Dust", "Polar_Star", "Amos'_Bow"],
        ["beidou", "chongyun", "gaming", "ningguang", "xiangling", "xingqiu", "xinyan", "yanfei", "yaoyao", "yunjin"],
        ["Dragon's_Bane", "Eye_of_Perception", "Favonius_Codex", "Favonius_Greatsword", "Favonius_Lance", "Favonius_Sword", "Favonius_Warbow", "Lion's_Roar", "Lithic_Blade", "Lithic_Spear", "Rainslasher", "Rust", "Sacrificial_Bow", "Sacrificial_Fragments", "Sacrificial_Greatsword", "Sacrificial_Sword", "The_Bell", "The_Flute", "The_Stringless", "The_Widsith"]
    ],
    wish_4_5_1_C: [
